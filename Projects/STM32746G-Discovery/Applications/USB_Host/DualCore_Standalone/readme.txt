...
USB host application based on the STM32F746xx multi core support feature integrating Mass Storage (MSC) and
Human Interface (HID) in the same project.

This is a typical application on how to use the STM32F746xx USB OTG Host peripheral to operate with an USB MSC
...
A menu is displayed and the user can select any operation from the menu using the User button:
...
@par Hardware and Software environment
  ...
  - STM32746G-Discovery Set-up
    ...
    - Plug the HID device(Mouse/Keyboard) into the STM32746G-Discovery board through 'USB micro A-Male 
      to A-Female' cable to the connector:
