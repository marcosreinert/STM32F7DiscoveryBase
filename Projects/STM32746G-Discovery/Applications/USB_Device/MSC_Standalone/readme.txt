...
use USB device application based on the Mass Storage Class (MSC) on the STM32F746xx devices.
...
native PC Host MSC driver to which the STM32746G-Discovery board is connected.
