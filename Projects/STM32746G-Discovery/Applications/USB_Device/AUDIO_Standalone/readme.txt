...
(Out: Speaker/Headset) capability on the STM32F746xx devices.
...
This is a typical application on how to use the STM32F746xx USB OTG Device peripheral and SAI peripheral to 
stream audio data from USB Host to the audio codec implemented on the STM32746G-Discovery board.
...
@par Hardware and Software environment
  ...
  - STM32746G-Discovery RevB Set-up
    - Connect the STM32746G-Discovery RevB board to the PC through 'USB micro A-Male 
      to A-Male' cable to the connector CN13 to use USB Full Speed (FS)
    - Plug an external headset into CN10 connector.
