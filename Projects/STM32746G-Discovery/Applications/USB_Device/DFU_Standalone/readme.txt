...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F746xx devices.
...
In this application, two operating modes are available:
 ...
 2. Run-time application mode: 
    This is the normal run-time activities. A binary which toggles LED1 on the discovery board is 
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32746G_DISCOVERY_SysTick_0x08008000.dfu" provided in Binary
     directory.
