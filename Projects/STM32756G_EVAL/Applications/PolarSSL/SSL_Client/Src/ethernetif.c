/**
  ******************************************************************************
  * @file    PolarSSL/SSL_Client/Src/ethernetif.c
...
uint8_t Tx_Buff[ETH_TXBUFNB][ETH_TX_BUF_SIZE] __attribute__((at(0x20003E8C))); /* Ethernet Transmit Buffer */
...
/**
  * @brief  Timer callback function that calls etharp_tmr()
