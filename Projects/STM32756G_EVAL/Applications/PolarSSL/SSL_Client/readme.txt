...
In this application the client (STM32756G-EVAL) sends a crypted message to the 
...
@par Directory contents  
    ...
    - PolarSSL/SSL_Client/Inc/stm32f7xx_it.h           Interrupt handlers header file 
    - PolarSSL/SSL_Client/Inc/stm32f7xx_hal_conf.h     Library Configuration file
    ...
    - PolarSSL/SSL_Client/Src/stm32f7xx_hal_msp.c      HAL MSP module
    - PolarSSL/SSL_Client/Src/stm32f7xx_it.c           Interrupt handlers 
    - PolarSSL/SSL_Client/Src/system_stm32f7xx.c       STM32 system clock configuration file
...
@par Hardware and Software environment  
  ...
  - This application has been tested with the following environments: 
     ...
     - ssl_server.exe: PC utility is used as SSL server application
        This utility is provided within STM32CubeF7 package under "/Utilities/PC_Software/ssl_server"             
  ...
  - STM32756G-EVAL Set-up 
    ...
    - RS232 link (used with HyperTerminal like application to display debug messages):
      ...
      CN8 (USART1) and PC serial port (115200 bauds, 8 bits, 1 stop bit, no parity, no flow control).
