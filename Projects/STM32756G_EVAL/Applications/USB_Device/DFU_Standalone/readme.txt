...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F7xx devices.

This is a typical application on how to use the STM32F7x6 USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32F7x6 devices.
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM327x6G_EVAL_SysTick_0x08008000.dfu" provided in Binary
     directory.
