...
This application shows how to use the USB device application based on the Device
Communication Class (CDC) compliant with the PSTN subprotocol. The USB Device and UART
peripherals are used..

This is a typical application on how to use the STM32F7x6 USB OTG Device peripheral where the STM32 MCU
...
To run this application, the user can use one of the following configurations:
 ...
 - Configuration 2: 
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the STM327x6G-EVAL board
