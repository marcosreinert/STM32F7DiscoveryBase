...
USB host application based on the STM32F7x6 multi core support feature integrating Mass Storage (MSC) and
Human Interface (HID) in the same project.

This is a typical application on how to use the STM32F7x6 USB OTG Host peripheral to operate with an USB MSC
...
@par Hardware and Software environment
  ...
  - STM327x6G-EVAL RevB Set-up
    ...
    - Plug the HID device(Mouse/Keyboard) into the STM327x6G-EVAL board through 'USB micro A-Male 
      to A-Female' cable to the connector:
