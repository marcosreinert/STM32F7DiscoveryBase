...
* @{
*/ 
#define GFX_DEMO_ADDRESS    0x080C0000
#define GFX_DEMO_SIGNATURE  0x5AA55AA5
/**
* @}
*/ 
...
#define  LL_I2C_WriteReg(I2Cx, Reg, Value)   WRITE_REG((I2Cx)->Reg, (Value)) 
/**
* @}
*/ 
...
{ 
  ...
  */
  ...
  /* Create GUI task */
  osThreadDef(GUI_Thread, GUIThread, osPriorityNormal, 0, 55 * configMINIMAL_STACK_SIZE);
