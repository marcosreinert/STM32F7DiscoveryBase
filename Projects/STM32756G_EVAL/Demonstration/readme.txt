...
@par Hardware and Software environment
  ...
  - Jumpers configuration:
      - JP10: must be not fitted (NOR write protection)
      - JP18: <1-2> (used for audio player module)
      - JP19: <1-2> (used for audio player module)	  	  
      - JP21: <1-2> (used for audio player module)
      - JP22: <1-2> (used for audio player module)
...
In order to make the program work, you must do the following :
 ...
 - Rebuild all files
 - Open STM32 ST-Link Utility V3.6, click on "External Loader" from the bar menu then check "M29W128GL_STM32F756G-EVAL" box 
 - Connect the STM327x6G-EVAL board to PC with USB cable through CN21
 - Use "STM32CubeDemo_STM327x6G-EVAL_V1.0.0.hex" file with STM32 ST-Link Utility to program both internal Flash and external NOR memory
