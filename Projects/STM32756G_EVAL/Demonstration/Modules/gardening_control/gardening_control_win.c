...
//#define ID_ICONVIEW_SUBMENU       (GUI_ID_USER + 0x04)
...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect,      "main",      ID_TEXT_CONTROL,        60,  295,  100,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "control",    ID_TEXT_CONTROL2,        110,  295,  100,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "(on/off)",    ID_TEXT_CONTROL3,        85,  315,  100,  30,  0, 0x0,  0 },	
  { TEXT_CreateIndirect,      "sprinklers", ID_TEXT_SPRINKLERS,    285,  295,  100,  30,  0, 0x0,  0 },
  { TEXT_CreateIndirect,      "drowise",    ID_TEXT_DROWISE,        490, 295,  100,  30,  0, 0x0,  0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = BUTTON_CreateEx(20,  100, 180, 200, pMsg->hWin, WM_CF_SHOW, 0, ID_BUTTON_CONTROL);
    WM_SetCallback(hItem, _cbButton_control);     
      
    hItem = BUTTON_CreateEx(230, 80, 180, 200, pMsg->hWin, WM_CF_SHOW, 0, ID_BUTTON_SPRINKLERS);
    WM_SetCallback(hItem, _cbButton_sprinklers); 

    hItem = BUTTON_CreateEx(440, 100, 180,  200, pMsg->hWin, WM_CF_SHOW, 0, ID_BUTTON_DROWISE);
